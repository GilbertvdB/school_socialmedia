<x-app-layout>
    ...
    <div id="loading" class="py-4" style="display: none;">
        <div class="border text-gray-500 flex items-center justify-center mx-auto space-x-2">
    ...
    <script>
        ...
        const loadMorePosts = () => {
            ...
            loading = true;
            page++;
            return fetch(`{{ url('dashboard/loadMorePosts?page=') }}${page}`)
                .then(response => {
                    if (!response.ok) {
